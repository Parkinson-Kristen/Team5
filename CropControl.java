...
public static int runCrops()
{
    int runCropsStatus = random.nextInt(LAND_RANGE) + LAND_BASE;  
    return runCropsStatus;            
}

public static int displayCrop()
{
    int displayCropStatus = random.nextInt(LAND_RANGE) + LAND_BASE;  
    return displayCropStatus;            
}
